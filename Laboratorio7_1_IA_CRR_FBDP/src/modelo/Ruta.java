...
public class Ruta {
    ...
    public static String LINEA9 = "/resources/CirculoLinea9.png";
    public static String LINEA10 = "/resources/CirculoLinea10.png";
    ...
    public static void cambiarRutas(TipoImagen tipoImagen){
        if(tipoImagen==TipoImagen.CIRCULO){
           ...
           LINEA9 = "/resources/CirculoLinea9.png";
           LINEA10 = "/resources/CirculoLinea10.png";
        }
           ...
           LINEA9 = "/resources/EquisLinea9.png";
           LINEA10 = "/resources/EquisLinea10.png";
        }
    }
}
