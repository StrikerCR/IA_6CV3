...
public class Cuadro extends JPanel{
    ...
    protected void paintComponent(Graphics gg){
        ...
        } else if(tipoImagen == TipoImagen.LINEA9){
            imagen = new ImageIcon(getClass().getResource(Ruta.LINEA9));
        } else if(tipoImagen == TipoImagen.LINEA10){
            imagen = new ImageIcon(getClass().getResource(Ruta.LINEA10));
        } 
